...
FAKE_BOOL_CVAR(cs2scrim_admin_ban, "Whether to enable ban", g_bEnableBan, true, false)
FAKE_BOOL_CVAR(cs2scrim_admin_gag, "Whether to enable gag", g_bEnableGag, true, false)
FAKE_BOOL_CVAR(cs2scrim_admin_kick, "Whether to enable kick", g_bEnableKick, true, false)
FAKE_BOOL_CVAR(cs2scrim_admin_slay, "Whether to enable slay", g_bEnableSlay, true, false)
FAKE_BOOL_CVAR(cs2scrim_pause, "Whether to enable pause", g_bEnablePause, true, false)
FAKE_BOOL_CVAR(cs2scrim_practice_spawn, "Whether to enable practice spawns", g_bEnablePraccSpawn, true, false)
FAKE_BOOL_CVAR(cs2scrim_pracc, "Whether to enable practice mode", g_bEnablePractice, true, false)
FAKE_BOOL_CVAR(cs2scrim_rcon, "Whether to enable rcon functionality", g_bEnableRcon, true, false)
FAKE_BOOL_CVAR(cs2scrim_demo, "Whether to enable demo recording", g_bEnableRecord, true, false)
FAKE_BOOL_CVAR(cs2scrim_restore, "Whether to enable round backup command", g_bEnableRestore, true, false)
FAKE_BOOL_CVAR(cs2scrim_scrim, "Whether to enable scrim command", g_bEnableScrim, true, false)
FAKE_BOOL_CVAR(cs2scrim_admin_team, "Whether to enable setteam by admin", g_bEnableTeamControl, true, false)
FAKE_BOOL_CVAR(cs2scrim_admin_teleport, "Whether to enable admin teleport", g_bEnableTeleport, true, false)
